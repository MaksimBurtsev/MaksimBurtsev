...
На данный момент я прохожу QA стажировку в Lad Academy, где активно работаю над созданием трекера задач https://lad-academy.ru/project-task-tracker и принимаю участие в каждом этапе разработки.
