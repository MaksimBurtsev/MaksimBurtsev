...
SQL, REST API, DevTools, Git, Jira, Trello, Postman, Notion, TestIT, Qase, TestRail. Zephyr(JIRA). Sitechco, VSCode, Charles Proxy, Fiddler, Android Studio, SauselLabs, Browserstack, Apache JMeter, Wireshark, OWASP ZAP, Figma
